...
update_post_meta($post_id, 'testtimonial', $testiarray);
   ...
   foreach( $get_intermediate_image_sizes as $_size ) {      if ( in_array( $_size, array( 'thumbnail', 'medium', 'large' ) ) ) {        $sizes[ $_size ]['width'] = get_option( $_size . '_size_w' );
	...
	.item > figure{width:'.$testimonials_width.'px !important;height:'.$testimonials_height.'px !important;}
...
.owl-buttons div.testimonial_next:before{content:'\f138    ';}
	...
	.pcolor::before{content:'\f10d';font-family:"fontAwesome"; padding-right: 5px;}
	.pcolor::after{content:'\f10e';font-family:"fontAwesome"; padding-left: 5px;}
...
jQuery(document).ready(function($) {
	//alert(121);
	jQuery('body').find('.owl-prev').addClass('testimonial_prev');
   jQuery('body').find('.owl-next').addClass('testimonial_next');
